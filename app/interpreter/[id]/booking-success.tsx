...
export default function BookingSuccessScreen() {
    ...
    const interpreter = interpreters.find((item) => item.id.toString() === interpreterId);

    if (!interpreter) {
        return <View style={styles.screen}><Text>Error: Booking details not found.</Text></View>;
    }
            ...
            <View style={styles.contentContainer}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.stepRow}>
                        <View style={styles.stepNumberContainer}><Text style={styles.stepNumberText}>1</Text></View>
                        <View style={styles.stepTextContainer}>
                            <Text style={styles.stepTitle}>{interpreter.name} reviews your request</Text>
                            <Text style={styles.stepBody}>Your interpreter will accept or decline shortly</Text>
                        </View>
                    </View>
                    <View style={styles.stepRow}>
                        <View style={styles.stepNumberContainer}><Text style={styles.stepNumberText}>2</Text></View>
                        <View style={styles.stepTextContainer}>
                ...
                <View style={[styles.section, { paddingVertical: 30 }]}>
                    ...
                    <View style={styles.sessionDetailsContainer}>
                        ...
                        <View style={styles.sessionDetailsRow}>
                            ...
                            <Text style={[styles.sessionDetailsValue, styles.statusPending]}>Pending Approval</Text>
                        </View>
                    </View>
                </View>

      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.profileSection}>
          ...
          <View style={styles.ratingContainer}>
            ...
            <Text style={styles.reviewText}>{interpreter.rating} (reviews)</Text> 
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.chipContainer}>
            <Chip style={styles.chip} textStyle={styles.chipText}>{interpreter.specialisation}</Chip>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Card style={styles.reviewCard}>
            <Card.Content style={styles.reviewCardContent}>
              ...
              <Text style={styles.reviewBody}>"Excellent service! Maria was professional and very helpful during my medical appointment."</Text>
            </Card.Content>
          </Card>
        </View>
